...
Description: This script draws from the public access speckle filters modules 
**/
...
var s1 = ee.ImageCollection('COPERNICUS/S1_GRD_FLOAT')
      ...
      // Define Orbit pass number if selecting 'DESCENDING' orbit
      //.filter(ee.Filter.eq('relativeOrbitNumber_start', 154))// Define if Descending orbit
